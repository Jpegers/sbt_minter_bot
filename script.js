...
const ui = new TonConnectUI({
  manifestUrl: 'https://your-domain.com/manifest.json'
});
...
connectBtn.addEventListener('click', async () => {
  try {
    ...
    const walletAddress = state.account.address;
    if (!formState.wallets.includes(walletAddress)) {
      formState.wallets.push(walletAddress);
      updateWalletList();
    }
  } catch (err) {
